...
const routes: Routes = [
    ...
    { path: 'donnees-personnelles'      , canActivate: [AuthGuardService],  loadChildren: './app-view/all-settings/user-data/user-data-list/user-data-list.module#UserDataListPageModule' },
    { path: 'donnees-personnelles/:id'  , canActivate: [AuthGuardService],  loadChildren: './app-view/all-settings/user-data/user-data-set/user-data-set.module#UserDataSetPageModule' },
